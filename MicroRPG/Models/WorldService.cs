    ...
    public class WorldService
    {
        ...
        private static List<Monster> GenerateMonsters()
        {
            return new List<Monster>
            {
                ...
                new Monster {Name="Cheetah", Tags=new List<string>{"Forest, Village" }, Special="Special: Cheetahs are natural and stealthy hunters and have exceptional speed, matched by few.", Speed=18, HP=12, Reduction=0, Damage="2d6", DataName="cougar"},
