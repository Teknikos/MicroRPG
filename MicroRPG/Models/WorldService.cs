...
new Monster {Name="Spectre", Tags=new List<string>{"Desert, Ruins" }, Special="Special: Spectres are unnatural creatures held on the natural plane by necromantic energies. They are almost invulnerable to normal weapons. They can be damaged by magic.", Speed=8, HP=8, Reduction=15, Damage="1d6"},
